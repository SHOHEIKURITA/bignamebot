...
if ($message_text == '名言') {
    ...
    else if ($r == 16) {$return_message_text = "残念ながら君たちのものをプレゼンすると、小物だなと思われると思う。あいつちょっと大物かもしれんぞと思われるような、そういう発想をして欲しい。";}
    ...
    else if ($r == 23) {$return_message_text = "どこまでいっても、どこまでやっても勝利はない。また別の視点とか良さがあるんじゃないかとは常に思う。でもクライアントに出すときは考え尽くしたものを出す。";}
